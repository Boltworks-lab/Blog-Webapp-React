...
class ProfileView(LoginRequiredMixin, generics.RetrieveUpdateAPIView):
    permission_classes = [AllowAny]
...
class LikePostAPIView(LoginRequiredMixin, APIView):
    @swagger_auto_schema(
...
class BookmarkPostAPIView(LoginRequiredMixin, APIView):
    @swagger_auto_schema(
        request_body=openapi.Schema(
            type=openapi.TYPE_OBJECT,
            properties={
...
class DashboardStats(LoginRequiredMixin, generics.ListAPIView):
...
class DashboardPostCreateAPIView(LoginRequiredMixin, generics.CreateAPIView):
    serializer_class = api_serializer.PostSerializer
    permission_classes = [AllowAny]
...
class DashboardPostEditAPIView(LoginRequiredMixin, generics.RetrieveUpdateDestroyAPIView):
    serializer_classes = api_serializer.PostSerializer
    permission_classes = [AllowAny]
