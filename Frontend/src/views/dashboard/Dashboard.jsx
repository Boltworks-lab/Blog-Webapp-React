                    ...
                    <div className="row g-4">
                        ...
                        <div className="col-md-6 col-xxl-4">
                            <div className="card border h-100">
                                ...
                                <div className="card-footer border-top text-center p-3">
                                    <a href="/post/" className="fw-bold text-decoration-none text-dark">
                                        View all Posts
                                    </a>
                        ...
                        <div className="col-md-6 col-xxl-4">
                            <div className="card border h-100">
                                ...
                                <div className="card-footer border-top text-center p-3">
                                    <a href="/comments/" className="fw-bold text-decoration-none text-dark">
                                        View all Comments
                                    </a>
                                </div>
                            </div>
                                                ...
                                                <div className="d-flex justify-content-between position-relative">
                                                    <div className="d-sm-flex">
                                                        ...
                                                        <div className="ms-0 ms-sm-3 mt-2 mt-sm-0">
                                                            ...
                                                            {n.type === "like" && (
                                                                        <p>
                                                                            Someone liked your post <b>{n?.post?.title?.slice()}...</b>
                                                                        </p>
                                                                    )} {n.type === "like" && (
                                                                        <p>
                                                                            Someone liked your post <b>{n?.post?.title?.slice()}...</b>
