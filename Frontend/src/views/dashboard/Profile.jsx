...
function Profile() {
    ...
    return (
        <>
            <Header />
            <section className="pt-5 pb-5 container-fluid">
                                    ...
                                    <div>
                                        ...
                                        <div className="row gx-3">
                                            ...
                                            <div className="mb-3 col-12 col-md-12">
                                                ...
                                                <input onChange={handleProfileChange} name="bio" type="text" id="fname" className="form-control" value={profileData?.bio || ""} placeholder="Write a catchy bio!" required="" />
                                                <div className="invalid-feedback">Please enter first name.</div>
                                            </div>
                                            <div className="mb-3 col-12 col-md-12">
                                                ...
                                                <textarea onChange={handleProfileChange} name="about" placeholder="Tell us about yourself..." id="" value={profileData?.about || ""} cols="30" rows="5" className="form-control"></textarea>
                                            ...
                                            <div className="mb-3 col-12 col-md-12">
                                                ...
                                                <input onChange={handleProfileChange} name="country" type="text" id="country" className="form-control" value={profileData?.country || ""} placeholder="What country are you from?" required="" />
